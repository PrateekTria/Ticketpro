...
public final class Intents {
  ...
  public static final class Scan {
    ...
    public static final String SOURCE = "SCAN_SOURCE";
    
    public static final String EXTRA_SOURCE_INTEGRATED = "SCAN_SOURCE_INTEGRATED";
    
    public static final String EXTRA_SOURCE_NATIVE = "SCAN_SOURCE_NATIVE";
  ...
  public static final class Result {
    ...
    public static final String TYPE = "RESULT_TYPE";
    public static final String DISPLAY_TEXT = "RESULT_DISPLAY_TEXT";
