...
public class PaystationEventsByRegionRequest extends PaystationSoapRequest{
    ...
    public PaystationEventsByRegionRequest(){}
    
    public PaystationEventsByRegionRequest(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
