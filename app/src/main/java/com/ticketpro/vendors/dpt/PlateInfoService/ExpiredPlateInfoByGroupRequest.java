...
public class ExpiredPlateInfoByGroupRequest extends PlateSoapRequest{
    ...
    public ExpiredPlateInfoByGroupRequest(){}
    
    public ExpiredPlateInfoByGroupRequest(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
