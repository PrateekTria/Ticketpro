...
public class ExpiredPlateInfoByRegionRequest extends PlateSoapRequest {
    
    public String token;
    public String region;
    public int gracePeriod;
    
    public ExpiredPlateInfoByRegionRequest(){}
    
    public ExpiredPlateInfoByRegionRequest(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
