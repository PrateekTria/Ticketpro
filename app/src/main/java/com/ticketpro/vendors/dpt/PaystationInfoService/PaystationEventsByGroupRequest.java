...
public class PaystationEventsByGroupRequest extends PaystationSoapRequest{
    ...
    public PaystationEventsByGroupRequest(){}
    
    public PaystationEventsByGroupRequest(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
