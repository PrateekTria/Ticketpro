...
public class PaystationEventsBySerialRequest extends PaystationSoapRequest {
    
    public String token;
    public VectorPaystationSerialListType paystationevents;
    public String dateFrom;
    public String dateTo;
    public VersionType version;
    public boolean versionSpecified;
    
    public PaystationEventsBySerialRequest(){}
    
    public PaystationEventsBySerialRequest(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        ...
        if (soapObject.hasProperty("paystationevents"))
        {
            SoapObject j = (SoapObject)soapObject.getProperty("paystationevents");
            paystationevents = new VectorPaystationSerialListType(j);
        }
