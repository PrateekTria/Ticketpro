...
public class ChalkMenuFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        expandAdapter = new ExpandListAdapter(((ChalkMenuActivity)getActivity()).getContent(), menus);
		...
		public View getChildView(int actionPosition, int childPosition, boolean isLastChild, View view,ViewGroup parent) {
			...
			view.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					((ChalkMenuActivity)getActivity()).getSlideoutHelper().close();
					((ChalkMenuActivity)getActivity()).callAction(actionItem);
				}
			});
