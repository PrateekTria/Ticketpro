 ...
 */
package com.ticketpro.lpr.lang;
...
import com.ticketpro.lpr.LPRCaptureActivity;
...
public final class TranslateAsyncTask extends AsyncTask<String, String, Boolean> {
  ...
  public TranslateAsyncTask(LPRCaptureActivity activity, String sourceLanguageCode, String targetLanguageCode, 
      String sourceText) {
