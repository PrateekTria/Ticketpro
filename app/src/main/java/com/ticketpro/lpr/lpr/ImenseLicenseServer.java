...
import com.ticketpro.parking.activity.PhotosChalkActivity;
import com.ticketpro.parking.activity.PhotosChalkListActivity;
...
final public class ImenseLicenseServer extends AsyncTask<Void, Void, Boolean> {
    ...
    private static final String identity = "turbodata.com";
    //commercial license account
    private static final String ImenseLicenseServerLogin = decodeString("TG9naW42MTA5MDM=");
    private static final String ImenseLicenseServerPassword = decodeString("OG41NHlmNzNvNmlk");
    ...
    private Activity androidAppContext;
    ...
    public ImenseLicenseServer(WriteTicketActivity androidAppContext, String device_uid) {
        this.androidAppContext = androidAppContext;
        this.device_uid = device_uid;
    }

    public ImenseLicenseServer(PhotosChalkActivity androidAppContext, String device_uid) {
        this.androidAppContext = androidAppContext;
        this.device_uid = device_uid;
    }

    public ImenseLicenseServer(PhotosChalkListActivity androidAppContext, String device_uid) {
        this.androidAppContext = androidAppContext;
        this.device_uid = device_uid;
    }
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (licensekey != null) {
            ...
            if (androidAppContext instanceof WriteTicketActivity) {
                WriteTicketActivity.licenseKey = licensekey;
                TPConstant.licensekey = licensekey;
            } else if (androidAppContext instanceof PhotosChalkActivity) {
                PhotosChalkActivity.licenseKey = licensekey;
                TPConstant.licensekey = licensekey;
            } else if (androidAppContext instanceof PhotosChalkListActivity) {
                PhotosChalkListActivity.licenseKey = licensekey;
                TPConstant.licensekey = licensekey;
            }
        } else {
