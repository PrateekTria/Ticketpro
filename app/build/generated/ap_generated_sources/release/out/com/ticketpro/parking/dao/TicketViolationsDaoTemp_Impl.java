...
public final class TicketViolationsDaoTemp_Impl implements TicketViolationsDaoTemp {
  private final RoomDatabase __db;

  private final EntityInsertionAdapter<TicketViolationTemp> __insertionAdapterOfTicketViolationTemp;

  private final SharedSQLiteStatement __preparedStmtOfRemoveAll;

  private final SharedSQLiteStatement __preparedStmtOfRemoveById;

  public TicketViolationsDaoTemp_Impl(RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfTicketViolationTemp = new EntityInsertionAdapter<TicketViolationTemp>(__db) {
      @Override
      public String createQuery() {
        return "INSERT OR REPLACE INTO `ticket_violations_temp` (`ticket_violation_id`,`violation_id`,`ticket_id`,`custid`,`violation_code`,`fine`,`citation_number`,`violation`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }

      @Override
      public void bind(SupportSQLiteStatement stmt, TicketViolationTemp value) {
    ...
    this.__preparedStmtOfRemoveAll = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Delete from ticket_violations_temp";
        return _query;
      }
    };
    this.__preparedStmtOfRemoveById = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Delete from ticket_violations_temp where ticket_violation_id=?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void insertTicketViolation(final TicketViolationTemp... data) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfTicketViolationTemp.insert(data);
  ...
  @Override
  public Completable insertTicketViolation(final TicketViolationTemp data) {
  ...
  @Override
  public void insertTicketViolationList(final List<TicketViolationTemp> TicketViolationsList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfTicketViolationTemp.insert(TicketViolationsList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<TicketViolationTemp> getTicketViolations() {
    final String _sql = "select * from ticket_violations_temp";
    ...
    try {
      ...
      final List<TicketViolationTemp> _result = new ArrayList<TicketViolationTemp>(_cursor.getCount());
      while(_cursor.moveToNext()) {
        final TicketViolationTemp _item;
        _item = new TicketViolationTemp();
  ...
  @Override
  public List<TicketViolationTemp> getTicketViolationsByCitation(final long citationNumber) {
  ...
  @Override
  public List<TicketViolationTemp> getTicketViolationWithComments(final long ticketId) {
  ...
  @Override
  public List<TicketViolationTemp> getTicketViolationByCitationWithComments(
      final long citationNumber) {
  ...
  @Override
  public TicketViolationTemp getViolationByPrimaryKey(final String violationId) {
    final String _sql = "select * from ticket_violations_temp where ticket_violation_id=?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (violationId == null) {
    ...
    try {
      ...
      final int _cursorIndexOfCitationNumber = CursorUtil.getColumnIndexOrThrow(_cursor, "citation_number");
      final int _cursorIndexOfViolationDesc = CursorUtil.getColumnIndexOrThrow(_cursor, "violation");
      final TicketViolationTemp _result;
      if(_cursor.moveToFirst()) {
        _result = new TicketViolationTemp();
        final int _tmpTicketViolationId;
        _tmpTicketViolationId = _cursor.getInt(_cursorIndexOfTicketViolationId);
  ...
  public int getNextPrimaryId() {
    final String _sql = "select max(ticket_violation_id) as max_ticket_violation_id from ticket_violations_temp";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
  ...
  @Override
  public int getCount() {
    final String _sql = "SELECT COUNT(ticket_violation_id) FROM ticket_violations_temp";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    __db.assertNotSuspendingTransaction();
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
