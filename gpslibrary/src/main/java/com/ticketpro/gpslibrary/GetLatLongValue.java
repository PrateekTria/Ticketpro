...
public class GetLatLongValue {
    ...
    public GetLatLongValue(Activity ctx, MyTracker.ADLocationListener locListener) {
        this.ctx = ctx;
    ...
    public void track() {
        ...
        //Not being used Commented on 28 June 2022
